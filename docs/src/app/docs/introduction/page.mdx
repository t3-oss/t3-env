...
- 🔒 **Type-safe environment variables** - Get autocomplete and type checking for your environment variables
- 🔄 **Standard Schema support** - Use any [Standard Schema](https://standardschema.dev) compliant validator (Zod, Valibot, ArkType, Typia, etc.)
- 🎯 **Server/Client separation** - Prevent accidental exposure of server variables to the client
- 🚀 **Framework agnostic** - Works with Next.js, Nuxt, Vite, and any other framework
- 📦 **Presets included** - Ready-to-use configurations for Vercel, Netlify, Railway, and more
